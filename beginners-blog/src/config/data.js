export const blogList = [
  {
    ...
    description: [
      ...
      `<h2>1. Udemy</h2>
      <p><strong>Udemy</strong> is one of the most popular online learning platforms, offering a wide range of web development courses for beginners, intermediate learners, and advanced developers. With courses on <em>HTML</em>, <em>CSS</em>, <em>JavaScript</em>, <em>React</em>, <em>Node.js</em>, and more, Udemy provides a diverse selection of topics to choose from. The platform is known for its affordability, lifetime access to courses, and frequent discounts.</p>`,
      `<h2>2. Coursera</h2>
      <p><strong>Coursera</strong>  is another top choice for web development courses, offering programs from universities and institutions worldwide. Coursera's courses cover a variety of topics, including front-end development, full-stack development, and web design. Learners can earn certificates and even degrees in web development through Coursera's partnerships with universities.</p>
      ...
      `<h2>3. YouTube</h2>
      <p> <strong>YouTube</strong> is a valuable resource for learning web development, with a plethora of free tutorials, coding channels, and web development series. From beginner-friendly tutorials to in-depth coding projects, YouTube offers a wealth of content for developers of all levels. Some popular channels for web development include Traversy Media, The Net Ninja, and freeCodeCamp.</p>`,
      `<h2>4. Pluralsight</h2>
      <p><strong>Pluralsight</strong> is a tech-focused learning platform that offers web development courses, tutorials, and assessments. With courses on front-end frameworks, back-end technologies, and web development tools, Pluralsight caters to developers of all skill levels. The platform also provides skill assessments and learning paths to help learners track their progress and set goals.</p>`,
      `<h2>5. Codecademy</h2>
      <p><strong>Codecademy</strong> is an interactive platform that offers coding courses in web development, programming, and data science. With hands-on exercises, quizzes, and projects, Code Academy helps learners build practical skills in HTML, CSS, JavaScript, and more. The platform also offers a free plan with limited access to courses and a premium plan for full access to content.</p>`,
      `<h2>My take</h2>
      <p>What really helped me the most in my experience at the very start of my learning journey was the course <a href="https://www.udemy.com/course/javascript-beginners-complete-tutorial/">Modern React with Redux</a> which is a React + Redux state management course by Stephen Grider, it was very detailed and easy to follow and i was able to follow along with his excercises and build the projects he built in the course which helped me understand the concepts better and apply them in real world projects.</p>`,
      ...
      `<p>I would note that there is no one package course that fits all when it comes to learning web development, you have to try from different resources and see which one works best for you, for me it was <b>Udemy</b>, <b>Coursera</b>, <b>ChatGPT</b>, <strong>YouTube</strong> and reading documentation, if you already have a good knowledge of Javascript, the documentation of every stack you will learn is enough for you to learn them without the need to buy any course</p>`,
      `<p>Start working on projects as soon as you can, it will help you understand the concepts better and apply them in real world projects, you can start with small projects like a <b>to-do list</b> app or a <b>weather app</b> and then move on to more complex projects like a <b>social media app</b> or a <b>blog</b> app. Or you can swim against the current and start with a big project and learn as you go, my biggest project is a chat application that i am building with <em>next.js</em> and <em>socket.io</em> with <em>redux state management</em> and i am learning as i go and it is a very rewarding experience. <a href="https://superb-tarsier-40b1af.netlify.app/">You can check the frontend here</></p>`,
